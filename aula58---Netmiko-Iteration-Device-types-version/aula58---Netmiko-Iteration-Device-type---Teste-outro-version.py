# aula58---Netmiko-Iteration-Device-types-version.py
# Programa que verifica a versão do device e aplica comandos conforme o retorno do SHOW VERSION.
# Necessário fazer o rollback das alterações efetuadas nos devices na aula57, sobre Error Handling, pois os devices
# foram desconfigurados, foi shutada interface, trocada senha do usuário fernando, trocado o transporte da line vty para telnet, etc
# FAZER O ROLLBACK DA AULA57!
import pdb
...
with open('commands_file_prod_rel_team') as f:
...
for devices in devices_list:
    ...
    if software_ver == 'prod_rel_team':
        ...
        print ('Não atendeu os requisitos.')
    print (output)